--[[
    ...
    - Third Person and Top Down Scenes

    Getting Started - Gameplay Preview
    ========================

    1. Play the framework in preview mode. A Basic Dagger will be equipped automatically.
    ...
    Getting Started - Camera Perspective
    ========================
    
    1. This framework comes with two Scenes: Third Person, and Top Down.
    2. You can view them by navigating to Window -> Scenes.
    3. Try them both out, and once you've decided on one, click the [...] button next to the Scene you
    want, and select "Set as Main Scene" if it is not set as Main already.
    4. You should also ensure "Publish" is unchecked for the scene you are not using.
    5. You can now use your desired scene as a template for your game!
